...
INSERT INTO `program` VALUES ('p001','squash','a',5000),('p002','squash','b',6000),('p003','health','c',4000),('p004','health','d',8000),('p005','golf','e',10000);
...
CREATE TABLE `register` (
  ...
  `program_cd` char(4) DEFAULT NULL,
...
-- Dump completed on 2023-09-14 13:54:47
